...
export const sources: Source[] = [
  ...
  { id: 'vietmap-sdk', organization: 'VIETMAP JSC', title: 'VIETMAP Maps API – Tilemap và SDK Web GL', url: 'https://maps.vietmap.vn/docs/map-api/tilemap/', accessedAt: '20/07/2026', usedFor: 'Nền bản đồ vector tương tác có thể kéo, thu phóng và đọc địa danh. Bản đồ chỉ được kích hoạt khi có tilemap API key hợp lệ; project không tự chuyển sang nhà cung cấp khác.', copyright: 'Bản đồ © VIETMAP. API key và việc sử dụng chịu giới hạn tên miền, hạn mức và điều khoản của VIETMAP.' },
  { id: 'custom-map', organization: 'Dự án TỪ BẾN NHÀ RỒNG', title: 'Lớp hành trình và thông tin chủ quyền Việt Nam', url: '/journey', accessedAt: '20/07/2026', usedFor: 'Marker, đường hành trình và lớp thông tin Hoàng Sa, Trường Sa được thiết kế riêng cho mục đích giáo dục. Không sử dụng các đường yêu sách phi pháp trên Biển Đông. Tuyến đường là trực quan hóa các địa điểm tiêu biểu, không phải tuyến hàng hải chính xác tuyệt đối.', copyright: 'Dữ liệu hành trình thuộc nội dung dự án; nền bản đồ, khi được cấu hình, vẫn giữ attribution của VIETMAP.' }
];
